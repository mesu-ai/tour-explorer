    ...
    return (
        <Col>
            <Card className="h-100 shadow-lg p-2 package-card">
                ...
                <Card.Text className="package-price mb-0"> <span className="cost mb-0"> {price}</span> TK (single  Package)</Card.Text>
                ...
                <Button onClick={()=>props.handleDetails(_id)} className="btn btn-success mt-2">{props?.children}</Button>
